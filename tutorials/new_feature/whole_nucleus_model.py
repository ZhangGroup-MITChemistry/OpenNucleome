...
class OpenNucleome:
    ...
    def create_system(self, PDB_file, flag_membrane = False, lam_bond = None):
        ...
        self.bead_groups = [[] for _ in range(9)] # group the indexes of atoms by their types; if you do not want to add some nuclear landmarks, then use the different value. compartment A: 1, compartment B: 2, regions around the centromeres: 3, centromeres: 4, nucleoli: 5, dP speckles: 6, P speckles: 7, new beads: 8, lamina: 9
